...
class TestData(BaseDataset):
    ...
    def get_item(self, idx):
        ...
        print("Loading image {}".format(rgb_file)) # linycs add
        pasta_file = rgb_file.replace(f'color.jpg', 'pasta.json')
        ...
        res['pasta'] = json.load(open(pasta_file, 'r')) if exists(pasta_file) else None # linycs add
        return res
